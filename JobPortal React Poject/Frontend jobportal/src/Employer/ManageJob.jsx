...
export default function JobCategory() {
  ...
  const handleSubmitEdit = () => {
    ...
    axios
      ...
      .then(() => {
        ...
        // You might want to fetch the updated jobs list from the database again
        // after the edit operation to ensure that the UI reflects the changes
        getJobs();
      })
      .catch((err) => {
        console.error(err);
  ...
  return (
    <div>
      <EmpHeader/>
      <div className="max-w-screen-2xl container mx-auto xl:px-30 px-4 bg-[#F8F9FC]  mt-20 h-full">
