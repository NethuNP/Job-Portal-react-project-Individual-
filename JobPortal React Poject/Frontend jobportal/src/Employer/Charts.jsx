    ...
    const fetchData = async () => {
      try {
        const pendingResponse = await fetch(
          "http://localhost:8070/applications/pending/percentage"
        );
        const declinedResponse = await fetch(
          "http://localhost:8070/applications/declined/percentage"
        );
        const approvedResponse = await fetch(
          "http://localhost:8070/applications/approved/percentage"
        );
