...
const Plans = () => {
  ...
  const buyfunction = async (name, unitAmount) => {
    try {
      const response = await axios.post("http://localhost:8070/plans/", {
        name,
  ...
  const packages = [
    {
      ...
      monthlyPrice: 19,
      yearlyPrice: 199,
      description: "Join with our Starter Pack",
      monthlyPostJobs: 5,
      yearlyPostJobs: 50,
      trialDays: 5,
    },
    {
      ...
      monthlyPrice: 39,
      yearlyPrice: 399,
      description: "Join with our Advance Pack",
      monthlyPostJobs: 10,
      yearlyPostJobs: 100,
      trialDays: 10,
    },
    {
      ...
      monthlyPrice: 59,
      yearlyPrice: 599,
      description: "Join with our Premium Pack ",
      monthlyPostJobs: 15,
      yearlyPostJobs: 150,
      trialDays: 14,
      green: <MdCircle />,
    ...
    <div>
      ...
      <div className="md:px-14 p-4 max-w-s mx-auto py-10">
        <div className="text-center">
          <h2 className="md:text-5xl text-3xl font-bold text-blue mb-2 mt-12">
            Here are all our plans
          </h2>
          <p className="text-tartiary md:w-1/3 mx-auto px-4">
            You can buy our plans for posting your jobs
          </p>
              ...
              <div className="w-14 h-6 bg-gray-300 rounded-full transition duration-200 ease-in-out">
                <div
                  className={`w-6 h-6 rounded-full transition duration-200 ease-in-out ${
                    isYearly ? "bg-gray-500 ml-8" : "bg-gray-500"
                  }`}
                ></div>
              </div>
            ...
            >
              ...
              <ul className="mt-4 space-y-2 px-4">
                <li className="flex items-center text-black">
                  <MdCircle className="mr-2 text-green-600" /> Free Trial:{" "}
                  {pkg.trialDays} days
                </li>
                <li className="flex items-center text-black">
                  {" "}
                  <MdCircle className="mr-2 text-green-600" />{" "}
                  {isYearly
                    ? `Post ${pkg.yearlyPostJobs} Jobs/Year`
                    : `Post ${pkg.monthlyPostJobs} Jobs/Month`}
                </li>
              </ul>
              <div className="w-full mx-auto mt-8 flex items-center justify-center">
                <button
                  ...
                  className="bg-blue text-white px-5 py-2 rounded-2xl"
                >
                  Get Started
                </button>
              </div>
