    ...
    <div>
      ...
      <div className="container mx-auto xl:px-30 px-4 bg-white mt-20 h-full w-full ">
        <div className="py-4 px-10">
          ...
          <div>
            <button
              className="bg-blue text-white rounded-lg px-3 py-2 mt-10"
          ...
          <div className="flex justify-center mt-4 space-x-8 text-[#2c42a5]">
            ...
            <span className="mx-2 text-black">
              Page {currentPage} of{" "}
              {Math.ceil(approvedJobs.length / itemsPerPage)}
            </span>
            <button
              onClick={nextPage}
              disabled={
                currentPage === Math.ceil(approvedJobs.length / itemsPerPage)
              }
              className="hover:underline"
            >
              Next
        ...
        <div className="fixed inset-0 flex items-center justify-center bg-white bg-opacity-100 shadow-3xl">
          <div className="bg-white p-8 max-w-4xl">
            <div ref={pdfRef} className="mt-20">
              <h1 className="text-lg font-semibold mb-4 ml-10 mt-20">
                Report Details
              </h1>
                ...
                <tbody>
                  {currentJobs.map((job, index) => (
                    ...
                    >
                      ...
                      <td className="px-15 py-4 text-center">
                        {job.postingDate}
                      </td>
                      <td className="px-15 py-4 text-center">
                        {job.expireryDate}
            ...
            <div className="flex justify-end mt-4">
              <button
                ...
                className="bg-blue text-white rounded-lg px-3 py-2 mr-4"
              >
                Cancel
              </button>
              <button
