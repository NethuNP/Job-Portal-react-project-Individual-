...
export default function Slider() {
  ...
  return (
    <div>
      <p className="text-2xl text-blue font-semibold pt-10 ml-10 mt-10">
        Feedback
      </p>
      <div className="bg-blue mt-10 mb-10 py-5 shadow-3xl">
        <div className="max-w-3xl mx-auto relative">
          <div className="flex">
            <div
              className="w-11/12 mx-auto flex-shrink-0 p-4"
              data-aos="fade-in"
            >
                ...
                {feedback.length > 0 ? (
                  <>
                    ...
                    <p className="mt-2 text-gray-600">
                      From: {feedback[currentIndex].email}
                    </p>
                    <hr className="border-gray-300 my-4" />
                    <p className="mt-2 text-gray-600">
                      Reply: {feedback[currentIndex].reply}
                    </p>
                    <br />
                    <p className="font-semibold text-blue pl-56">
                      - JOBNEST Team -
                    </p>
                  </>
                ) : (
          ...
          {feedback.length > 1 && (
            <div className="absolute top-1/2 transform -translate-y-1/2 w-full px-4 flex justify-between">
              <button
                onClick={prevSlide}
                className="bg-gray-200 text-gray-700 hover:bg-gray-300 rounded-full p-2"
              >
                &laquo;
              </button>
              <button
